...
test:
	...
	cd ubuntu1604 && bazel test --test_output=errors $(CONTAINER_TEST_TARGETS) && cd ..
	cd ubuntu1804 && bazel test --test_output=errors $(CONTAINER_TEST_TARGETS) && cd ..
	cd debian9 && bazel test --test_output=errors $(CONTAINER_TEST_TARGETS) && cd ..
	cd centos7 && bazel test --test_output=errors $(CONTAINER_TEST_TARGETS) && cd ..
