...
Tests are implemented using the [structure_test](https://github.com/GoogleCloudPlatform/container-structure-test) library.
...
Note: running either set of tests requires installing
[container_diff](https://github.com/GoogleCloudPlatform/container-diff) and
having it on your PATH.
